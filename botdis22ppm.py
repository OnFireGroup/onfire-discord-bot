        ...
        for guild_id, channel_id in CHANNELS_ALLOWED.items():
            ...
            if guild:
                ...
                if channel:
                    ...
                    embed = discord.Embed(
                        title="🎮 **Status do Servidor PPMBR**",
                        description=f"**Jogadores Online:** {player_count}",
                        color=discord.Color.green()
                    )
                    embed.set_thumbnail(url="https://i.imgur.com/3bJY8u3.png")
                    ...
                    # Criar botão "Visitar OnFire"
                    button_onfire = Button(label="Visitar OnFire", style=discord.ButtonStyle.link, url="https://onfiregroup.com.br")
                    view = View()
                    view.add_item(button_onfire)
