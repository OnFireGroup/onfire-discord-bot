        ...
        for guild_id, channel_id in CHANNELS_ALLOWED.items():
            ...
            if guild:
                ...
                if channel:
                    ...
                    embed = discord.Embed(
                        title="🎮 [BR] Terra de Ninguem - 1PP Vanilla++ |KOT |BUNKER |",
                    ...
                    # Botões
                    view = View()
                    view.add_item(Button(label="Jogar Agora", style=discord.ButtonStyle.link, url="https://onfire.top/tdnpvp.html"))
